...
def create_table(table_name, columns):
    ...
    :param columns: A list of column names and data types, in the format "name data_type".
    """
...
def insert_record(table_name, values):
    ...
    :param values: A list of values to be inserted, in the same order as the table's columns.
    """
    # Connect to the database
    conn = sqlite3.connect(databaseFile)
    cursor = conn.cursor()
...
def select_all(table_name):
    ...
    :return: A list of tuples, where each tuple represents a record in the table.
    """
    # Connect to the database
    conn = sqlite3.connect(databaseFile)
    cursor = conn.cursor()
...
def select_by_value(table_name, column, value):
    ...
    :param conn: A connection object to the database.
    :param table_name: The name of the table to retrieve the records from.
    :param column: The name of the column to search for.
    :param value: The value of the column to search for.
    :return: A list of tuples representing the retrieved records.
    """
    conn = sqlite3.connect(databaseFile)
    cursor = conn.cursor()
...
def select_by_id(table_name, id):
    ...
    :param id: The value of the id column to search for.
    :return: A tuple representing the record with the matching id.
    """
    # Connect to the database
    conn = sqlite3.connect(databaseFile)
    cursor = conn.cursor()
...
def update_record(table_name, id, columns, values):
    """
    ...
    :param id: The value of the id column to search for.
    :param columns: A list of column names to be updated.
    :param values: A list of new values to be set for the columns, in the same order as the columns list.
    """
    # Connect to the database
    conn = sqlite3.connect(databaseFile)
    cursor = conn.cursor()
